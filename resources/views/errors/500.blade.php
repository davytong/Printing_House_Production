...
<body>
    <div class="error-card">
        ...
        <h3 class="fw-bold mb-2">មានបញ្ហាបច្ចេកទេស / System Error</h3>
        <p class="text-secondary mb-4" style="font-size: .9rem">
            ប្រព័ន្ធជួបប្រទះបញ្ហាបច្ចេកទេសក្នុងម៉ាស៊ីនបម្រើ។ យើងកំពុងជួសជុលវា។
            <br>
            <span class="text-muted" style="font-size: .8rem">The server encountered an internal error. We are working to resolve it.</span>
        </p>
