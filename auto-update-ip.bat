...
powershell -Command "(Get-Content 'D:\printing-tracker\printing-tracker\client-setup.bat') -replace 'set SERVER_IP=.*', 'set SERVER_IP=%CURRENT_IP%' | Set-Content 'D:\printing-tracker\printing-tracker\client-setup.bat'"
